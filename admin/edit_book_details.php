<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        if($conn->query($sql1) === TRUE){
            ...
            header( "Refresh:0.01; url=book.php?aid=$userId", true, 303);
        }
        else
        {//echo $conn->error;
                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <br >
                                <form class="form-horizontal row-fluid" action="edit_book_details.php?aid=<?=$userId?>&id=<?php echo $bookid ?>" method="post">
