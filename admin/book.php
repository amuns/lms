<?php
    ...
    if(!isset($_SESSION['type']) || $_SESSION['type'] != 'Admin'){
        ...
        echo "<script type='text/javascript'>('Please Log in as Admin!')</script>";
        unset($_SESSION['type']);
                    ...
                    <div class="span9">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><center>
                                    <a href="bookdetails.php?aid=<?=$userId?>&id=<?php echo $bookid; ?>" class="btn btn-primary">Details</a>
                                    <a href="edit_book_details.php?aid=<?=$userId?>&id=<?php echo $bookid; ?>" class="btn btn-success">Edit</a>
                                </center></td>
                            </tr>
                            <?php 
                                }
