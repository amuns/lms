        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="current.php?aid=<?=$userId?>" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="Search"><b>Search:</b></label>
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Enter User ID/Book Name/Book Id." class="span8" required>
