<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql1="insert into LMS.message (UserId,Msg,Date,Time) values ('$userId','$message',curdate(),curtime())";
        $result=$conn->query($sql1);
        if($result){
            $_SESSION['success']="Message Delivered!";
            header('location: message.php?aid='.$_GET['aid']);
            exit;
        }
        else
        {
                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" action="message.php?aid=<?=$_GET['aid'];?>" method="post">
                                    <div class="control-group">
                                        <label class="control-label" for="Rollno"><b>User ID:</b></label>
                                        <div class="controls">
                                            <input type="text" id="RollNo" name="UserId" placeholder="User ID" class="span8" required>
                                        </div>
                                    </div>
                                    <div class="control-group">
